---
title: "Welcome to AgenticVault Security Graph"
description: "Complete documentation for AgenticVault Security Graph - a modular OSINT investigation platform."
category: "Overview"
order: 1
...
### What is AgenticVault Security Graph?

AgenticVault Security Graph is a modular investigation and reconnaissance platform focused on OSINT (Open Source Intelligence). It provides:
...
### Why AgenticVault Security Graph?
...
This is exactly what AgenticVault Security Graph was built for: a solid and durable foundation on which your investigations rest. Tools become simple extensions that plug in and unplug easily. A new tool comes out, and with a few manipulations it can be integrated into your investigation workflow.

**AgenticVault Security Graph is the stable infrastructure that allows you to stay agile in the face of constant evolution of methods and sources.**

AgenticVault Security Graph is a local tool, running on your machine only. This ensures a great level of confidentiality, but comes with responsabilities.
