---
title: "Installation"
description: "Quick start guide to using AgenticVault Security Graph for your OSINT investigations."
...
Before installing AgenticVault Security Graph, ensure you have the following installed on your system:
