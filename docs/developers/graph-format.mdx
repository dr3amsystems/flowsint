---
title: "Graph format"
description: "Reference for the GraphNode and GraphEdge types used to represent entities and relationships in the AgenticVault Security Graph visualization. Understanding these structures is essential for working with the frontend visualization and the graph database layer."
category: "Developers"
order: 11
