  ...
  properties: {
    ...
    input: {
      ...
      properties: {
        type: {
          type: 'string',
          description: 'AgenticVault entity type the template takes as input'
        },
        key: {
          type: 'string',
          default: 'nodeLabel',
    ...
    output: {
      ...
      properties: {
        type: {
          type: 'string',
          description: 'AgenticVault entity type that the template returns'
        },
        is_array: {
          type: 'boolean',
          default: false,
...
request:
  ...
  headers:
    ...
    User-Agent: agenticvault-enricher
  timeout: 15
